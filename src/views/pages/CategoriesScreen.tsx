...
export function CategoryScreen({ userId, name, power }: { userId: number | undefined, name: string, power: number  }) {
    return (
        <Html>
                ...
                <div class="
                    ...
                    <form class="flex flex-col p-5" action="/auth/login" method="post">
                        <div style="margin-top: 5px; display: flex; justify-content: center; align-items: center;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold; text-align: center;">{name}</h1>
                        </div>
                        ...
                        <div style="margin-top: 20px; display: flex; justify-content: space-between; align-items: center;">
                            <label class="border-4 border-black hover:bg-blue-500 hover:text-white rounded-full" for="increase">
                                ...
                                <h1 style="margin: 40; font-size: 20px; font-weight: 500;">Battery %{power}</h1>
